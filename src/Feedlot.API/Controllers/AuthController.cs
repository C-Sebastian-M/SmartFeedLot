...
/// <summary>Controller de autenticación. Único endpoint que no requiere [Authorize].</summary>
[Route("api/auth")]
public sealed class AuthController : ApiControllerBase
{
    ...
    /// <summary>Registro de nuevo usuario (solo Admin puede registrar usuarios).</summary>
    [HttpPost("registro")]
